export default {
  prayers: {
    creed: 'Credo in Deum, Patrem omnipotentem, creatorem caeli et terrae. Et in Iesum Christum, Filium eius unicum, Dominum nostrum, qui conceptus est de Spiritu Sancto, natus ex Maria Virgine, passus sub Pontio Pilato, crucifixus, mortuus et sepultus. Descendit ad inferos, tertia die resurrexit a mortuis. Ascendit ad caelos, sedet ad dextram Dei Patris omnipotentis. Inde venturus est iudicare vivos et mortuos. Credo in Spiritum Sanctum, sanctam Ecclesiam catholicam, sanctorum communionem, remissionem peccatorum, carnis resurrectionem, vitam aeternam. Amen.',
  ...
  mysteries: {
    ...
    findingInTemple: 'Inventio in Templo',

    baptism: 'Baptismus Christi',
    weddingAtCana: 'Nuptiae in Canense',
    proclaimingKingdom: 'Annuntiatio Regni Dei',
    transfiguration: 'Transfiguratio Domini',
    institutionEucharist: 'Institutio Eucharistiae',

    agonyInGarden: 'Cruciatus in Horto',
    scourgingAtPillar: 'Flagellatio',
    crowningWithThorns: 'Coronatio cum Spinis',
    carryingCross: 'Bajulatio Crucis',
    crucifixion: 'Crucifixio',

    resurrection: 'Resurrectio',
    ascension: 'Ascensio',
    descentHolySpirit: 'Descensus Spiritus Sancti',
    assumption: 'Assumptio',
    coronation: 'Coronatio'
  },
}
